...
function ProdutoAdmin({ id, categoria, imagem, preco, nome, descricao}: tipos) {
    ...
    return (
        <div className={style.tudo}>
            ...
            {open && <EditarProduto open={open} onClose={()=> setOpen(false)} nome1={nome} preco1={preco} categoria1={categoria} imagem1={imagem} descricao1={descricao}></EditarProduto>}
        </div>
    );
}
